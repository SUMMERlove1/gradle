...
public abstract class HashCode implements Serializable, Comparable<HashCode> {
    ...
    /**
     * Encodes the hash code into a string.
     * <p>
    ...
    /**
     * Returns a human friendly representation of the hash.
     * <p>
     * The compact string retains all the information of the hash.
     * However, it cannot be used to restore the hash via {@link #fromString(String)}.
